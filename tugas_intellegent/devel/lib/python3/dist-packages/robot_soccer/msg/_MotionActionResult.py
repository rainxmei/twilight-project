...
"""autogenerated by genpy from robot_soccer/MotionActionResult.msg. Do not edit."""
import codecs
import sys
...
class MotionActionResult(genpy.Message):
  ...
  _type = "robot_soccer/MotionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_soccer/MotionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = robot_soccer.msg.MotionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_soccer.msg.MotionResult()
