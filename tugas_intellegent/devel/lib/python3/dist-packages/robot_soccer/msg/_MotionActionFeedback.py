...
"""autogenerated by genpy from robot_soccer/MotionActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MotionActionFeedback(genpy.Message):
  _md5sum = "14f6780a53cf5b3b4a12803557b97d3b"
  _type = "robot_soccer/MotionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_soccer/MotionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = robot_soccer.msg.MotionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_soccer.msg.MotionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.status_message = str[start:end].decode('utf-8', 'rosmsg')
      else:
