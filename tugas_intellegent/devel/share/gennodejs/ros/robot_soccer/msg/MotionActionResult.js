...
class MotionActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MotionResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotionActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = MotionResult.Resolve(msg.result)
    }
    else {
      resolved.result = new MotionResult()
    }
...
module.exports = MotionActionResult;
